  ...
  return (
    <header className="bg-black">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-12 px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-white text-2xl font-bold">ERO.IO</h1>
        <div className="flex flex-1 items-center justify-end md:justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="sm:flex sm:gap-4">
              <div
                className="block rounded-md bg-gray-800  px-5 py-2.5 text-sm font-medium 
              text-white cursor-pointer hover:bg-gray-700 transition"
              >
                {/* <Button > */}
